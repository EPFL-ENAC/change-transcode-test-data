...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[Rnet_H,Rnet_L]=Net_Radiation_Manager_2Temp(Ts_H,Ts_L,Latm,SvF,...
...
%Ts_H [°C]  surface radiative temperature of the upper element (vegetation or snow or ice ) 
%Ts_L [°C]  surface radiative temperature of the lower element (rock, bare soil, water, or urban ) 
...
%%% Rnet
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% This operates in case one or more Crock,Curb,Cwat,Cbare > 0 %%%% 
%%%%%%%%% HIP. ONLY ONE TEMPERATURE %%%%%%%%%%%%%%%%%%%%%%%%%
Twat=Ts_L;  Trock=Ts_L;  Turb=Ts_L; Tg=Ts_L; 
Tice = Ts_H;  TvHsun=Ts_H;  TvHshd=Ts_H;
TvLsun=Ts_H; TvLshd=Ts_H; Tsno=Ts_H; Tdeb=Ts_H;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% Incoming Longwave  %%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%
Rnet_H=Rnet_vegH + Rnet_vegL + Rnet_snow +Rnet_ice + Rnet_deb;
Rnet_L=Rnet_ground+Rnet_rock +Rnet_wat + Rnet_urb;
return